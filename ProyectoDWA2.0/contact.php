...
<body>
	<?php
		...
		if(mail($address, $e_subject, $msg, $headers)) {
			...
			echo "<h1>Correo enviado satisfactoriamente.</h1>";
			echo "<p>Gracias <strong>$first_name</strong>! , su mensaje ha sido enviado.</p>";
			echo "</div>";
			echo "</fieldset>";
    ...
    <a href="html/contact.html"><button type="button" class="btn btn-primary">Para regresar a la pagina anterior click aqui</button></a>
</body>
</html>
